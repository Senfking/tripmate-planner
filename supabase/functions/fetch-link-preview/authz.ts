...
// is_trip_member(trip_id, user_id) — the same RLS predicate used everywhere
// else in the schema. Returns a discriminated result so the caller can map
// 404 (attachment not found) vs 403 (not a member) into HTTP responses.
