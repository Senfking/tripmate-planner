...
const Privacy = () => (
  <div className="min-h-dvh bg-background">
    <div className="max-w-[600px] mx-auto pt-16 px-8">
      ...
      <h1 className="text-[24px] font-bold text-foreground mt-6">Privacy Policy</h1>
      <p className="text-muted-foreground mt-4 leading-[1.6]">
        This page is coming soon. We're working on our privacy policy and will publish it here shortly.
