    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] pb-[120px] pt-6" style={{ backgroundColor: "#F1F5F9" }}>
        <div className="mx-auto flex w-full max-w-md flex-col gap-3 px-4">
          <div className="h-7 w-28 rounded-lg skeleton-shimmer mb-1" />
          <div className="h-[220px] rounded-[20px] skeleton-shimmer" />
          <div className="h-[140px] rounded-[16px] skeleton-shimmer" style={{ animationDelay: "150ms" }} />
        </div>
      </div>
    );
  }
