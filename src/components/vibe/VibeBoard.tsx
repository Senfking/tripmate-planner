...
const QUESTIONS = [
  {
    ...
    options: ["Full send", "Go with the flow", "Balanced", "Slow & easy"],
  },
  {
    key: "budget",
    label: "Budget style",
    options: ["Treat ourselves", "Mid-range", "Budget-friendly", "As cheap as possible"],
  },
  {
    key: "accommodation",
    label: "Where do we sleep?",
    options: ["All together", "Own rooms", "Hostel life", "Don't mind"],
  },
  {
    key: "length",
    label: "How long?",
    options: ["Long weekend", "4–5 days", "A full week", "Week+"],
  },
  {
    key: "musthave",
    label: "Must-haves",
