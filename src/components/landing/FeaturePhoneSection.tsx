...
export function FeaturePhoneSection({
  ...
  // On mobile: text on top, phone below (always order copy → image).
  // On desktop: side-by-side, image on the requested side.
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl grid gap-12 lg:gap-20 lg:grid-cols-2 items-center relative">
        <div
          className={`order-2 ${imageOrder} flex justify-center ${imageJustify} landing-reveal-mockup`}
