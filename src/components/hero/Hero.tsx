      ...
      {typeof document !== "undefined" && createPortal(
        ...
        >
          <Link
            ...
            className="pointer-events-auto absolute left-1/2 -translate-x-1/2 text-[28px] sm:text-[30px] font-extrabold tracking-[0.32em] uppercase text-white/85 hover:text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)] transition-colors"
